      ...
      <div className="container naax-w-screen-sm mx-auto">
        <form className="space-y-4 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex justify-between">
            <button type="submit" formAction={login} className="py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-indigo-500 hover:bg-indigo-700">Log In</button>
            <button type="submit" formAction={signup} className="py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-green-500 hover:bg-green-700">Sign Up</button>
          </div>
        </form>
      </div>
    </div>
